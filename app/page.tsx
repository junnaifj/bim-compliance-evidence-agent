...
import CodexAgentWorkspace from "../components/CodexAgentWorkspace";
...
export default function Home() {
  ...
  const baseReport = useMemo(() => {
    const human = reportBrief.includeHumanReview
      ...
      : undefined;
    const english = buildReport(reviewedModel, reportFindings, "en", human, reportBrief.detail);
    const chinese = buildReport(reviewedModel, reportFindings, "zh", human, reportBrief.detail);
    const base =
